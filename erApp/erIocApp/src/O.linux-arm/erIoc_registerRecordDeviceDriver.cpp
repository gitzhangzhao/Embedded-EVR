...
/* Generated from ../O.Common/erIoc.dbd */
...
epicsShareExtern typed_rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_dfanoutRSET, *pvar_rset_erRSET, *pvar_rset_ereventRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_erRecordSizeOffset, pvar_func_ereventRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "compress", "dfanout", "er", "erevent", "event", "fanout",
...
static const recordTypeLocation rtl[] = {
    ...
    {(struct typed_rset *)pvar_rset_erRSET, pvar_func_erRecordSizeOffset},
    {(struct typed_rset *)pvar_rset_ereventRSET, pvar_func_ereventRecordSizeOffset},
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devCalcoutSoftCallback, *pvar_dset_ER_dset,
    *pvar_dset_ER_event_dset, *pvar_dset_devEventSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devBoDbState", "devCalcoutSoft", "devCalcoutSoftCallback", "ER_dset",
    "ER_event_dset", "devEventSoft", "devHistogramSoft", "devI64inSoft",
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_configure_ERRegister, pvar_func_dbndInitialize,
...
int erIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/zhangzh/Lab/erApp";
    ...
    runRegistrarOnce(pvar_func_configure_ERRegister);
...
/* erIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"erIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(erIoc_registerRecordDeviceDriver(*iocshPpdbbase));
}
